...
def profile(request, username):
    ...
    posts_list = Post.objects.select_related('author').filter(author__username=username)
...
def post_detail(request, post_id):
    ...
    posts_list = Post.objects.select_related('author').filter(author__username=post.author)
